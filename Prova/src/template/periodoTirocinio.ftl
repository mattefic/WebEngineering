...
<html lang="it">
	<head>
		<meta charset="utf-8" />
		<title>Internship Tutor - Periodo di tirocinio</title>
	...
	<!-- SIDE MENU -->
					...
					<div class="navbar navbar-default" role="navigation">
						...
						<div class="navbar-collapse sidebar-navbar-collapse collapse" aria-expanded="false">
							...
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="dettagliAzienda.html">
										I TUOI DATI
									</a>
								</li>
								<li>
									<a href="inserisciTirocinio.html">
										INSERISCI OFFERTA DI TIROCINIO
									</a>
								</li>
								<li>
									<a href="elencoCandidature.html">
			...
			<section class="page-header page-header-xs">
				<div class="container">
					...
					<h1 class="text-center">PERIODO DI TIROCINIO</h1>
						...
						<div class="col-md-6 col-sm-7">
							...
							<div class="box-static box-transparent box-bordered p-30">
								...
								<div class="box-title mb-30">
									<h2 class="fs-20">Periodo di tirocinio</h2>
								</div>
									...
									<fieldset>
										...
										<div class="row justify-content-center">										
											<div class="col-md-6 col-sm-6">
												<label for="register:pass1">Data inizio tirocinio</label>
												<label class="input mb-10">
													<input required="" type="date" name="dataInizio">
													<b class="tooltip tooltip-bottom-right">Inserite la data in cui lo studente inizierà il tirocinio</b>
												</label>
											</div>
										</div>
										...
										<div class="row justify-content-center">										
											<div class="col-md-6 col-sm-6">
												<label for="register:pass1">Data fine tirocinio</label>
												<label class="input mb-10">
													<input required="" type="date" name="dataFine">
													<b class="tooltip tooltip-bottom-right">Inserite la data in cui lo studente finirà il tirocinio</b>
												</label>
											</div>
										</div>
