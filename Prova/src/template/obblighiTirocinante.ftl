...
<html lang="it">
	<head>
		<meta charset="utf-8" />
		<title>Internship Tutor - Obblighi del tirocinante</title>
	...
	<!-- SIDE MENU -->
			...
			<section class="page-header page-header-xs">
				<div class="container">
					...
					<h1 class="text-center">OBBLIGHI DEL TIROCINANTE</h1>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="heading-title heading-border heading-color col-4" style="word-wrap: break-word;">
							<p><h5>OBBLIGHI DEL TIROCINANTE:</h5></p>
							<br>
							<p>
								<ul>
									...
									<li>Rispettare gli obblighi di riservatezza per quanto attiene ai dati, informazioni e conoscenze in merito all'attività di ricerca dell'ente/azienda, acquisiti durante e dopo lo svolgimento del tirocinio;</li>
